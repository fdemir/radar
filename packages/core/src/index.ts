...
export const findingSchema = z.object({
  id: z.string(), taskId: z.string(), title: z.string(), summary: z.string(),
  reason: z.string(), source: z.string(), url: z.url(), category: categorySchema,
  date: z.iso.datetime(), read: z.boolean(), saved: z.boolean(),
});
export const runSchema = z.object({
  id: z.string(), taskId: z.string(), started: z.number(), finished: z.number().nullable(),
  stage: z.number().int(), status: z.enum(["running", "completed", "failed", "cancelled"]),
  outcome: z.enum(["new", "unchanged", "error"]), summary: z.string(),
  findings: z.number().int(), sources: z.array(z.url()),
});
export const noticeSchema = z.object({
  id: z.string(), taskId: z.string(), findingId: z.string(), channel: z.literal("Email"),
